public class PersonInfo1 {
    ...
    public static String firstName = "Alexandru";
    public static String lastName = "Sauer";
    public static int studentNo = 300026641;
    public static String description = "Likes to take a lot pictures";
